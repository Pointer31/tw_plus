...
#ifndef GAME_SERVER_GAMEMODES_THTF_H
#define GAME_SERVER_GAMEMODES_THTF_H
#include <game/server/gamecontroller.h>
#include <game/server/entity.h>
#include <game/server/player.h>

class CGameControllerTHTF : public IGameController
{
	// balancing
...
public:
	CGameControllerTHTF(class CGameContext *pGameServer);
