...
MACRO_CONFIG_INT(SvScorelimit, sv_scorelimit, 20, 0, 10000, CFGFLAG_SAVE|CFGFLAG_SERVER, "Score limit (0 disables)")
...
MACRO_CONFIG_STR(SvWelcomeLine1, sv_welcome_line1, 900, "You can get more information using /info and /help", CFGFLAG_SAVE|CFGFLAG_SERVER, "welcome line 1, can be used for displaying something to somebody joining")
MACRO_CONFIG_STR(SvWelcomeLine2, sv_welcome_line2, 900, "", CFGFLAG_SAVE|CFGFLAG_SERVER, "welcome line 2, can be used for displaying something to somebody joining")
MACRO_CONFIG_STR(SvWelcomeLine3, sv_welcome_line3, 900, "", CFGFLAG_SAVE|CFGFLAG_SERVER, "welcome line 3, can be used for displaying something to somebody joining")
