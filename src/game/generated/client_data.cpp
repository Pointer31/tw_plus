...
static CAnimKeyframe x4276[] = {
	/* x4276[0] */ {  0.000000f,  0.000000f,  -4.000000f,  0.000000f, },
};
static CAnimKeyframe x4283[] = {
	/* x4283[0] */ {  0.000000f,  0.000000f,  10.000000f,  0.000000f, },
};
static CAnimKeyframe x4290[] = {
	/* x4290[0] */ {  0.000000f,  0.000000f,  10.000000f,  0.000000f, },
};
static CAnimKeyframe *x4297 = 0;
static CAnimKeyframe *x4321 = 0;
static CAnimKeyframe x4328[] = {
	/* x4328[0] */ {  0.000000f,  -7.000000f,  0.000000f,  0.000000f, },
};
static CAnimKeyframe x4335[] = {
	/* x4335[0] */ {  0.000000f,  7.000000f,  0.000000f,  0.000000f, },
};
static CAnimKeyframe *x4342 = 0;
static CAnimKeyframe *x4361 = 0;
static CAnimKeyframe x4368[] = {
	/* x4368[0] */ {  0.000000f,  -3.000000f,  0.000000f,  -0.100000f, },
};
static CAnimKeyframe x4375[] = {
	/* x4375[0] */ {  0.000000f,  3.000000f,  0.000000f,  -0.100000f, },
};
static CAnimKeyframe *x4382 = 0;
static CAnimKeyframe x4401[] = {
	/* x4401[0] */ {  0.000000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x4401[1] */ {  0.200000f,  0.000000f,  -1.000000f,  0.000000f, },
	/* x4401[2] */ {  0.400000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x4401[3] */ {  0.600000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x4401[4] */ {  0.800000f,  0.000000f,  -1.000000f,  0.000000f, },
	/* x4401[5] */ {  1.000000f,  0.000000f,  0.000000f,  0.000000f, },
};
static CAnimKeyframe x4408[] = {
	/* x4408[0] */ {  0.000000f,  8.000000f,  0.000000f,  0.000000f, },
	/* x4408[1] */ {  0.200000f,  -8.000000f,  0.000000f,  0.000000f, },
	/* x4408[2] */ {  0.400000f,  -10.000000f,  -4.000000f,  0.200000f, },
	/* x4408[3] */ {  0.600000f,  -8.000000f,  -8.000000f,  0.300000f, },
	/* x4408[4] */ {  0.800000f,  4.000000f,  -4.000000f,  -0.200000f, },
	/* x4408[5] */ {  1.000000f,  8.000000f,  0.000000f,  0.000000f, },
};
static CAnimKeyframe x4415[] = {
	/* x4415[0] */ {  0.000000f,  -10.000000f,  -4.000000f,  0.200000f, },
	/* x4415[1] */ {  0.200000f,  -8.000000f,  -8.000000f,  0.300000f, },
	/* x4415[2] */ {  0.400000f,  4.000000f,  -4.000000f,  -0.200000f, },
	/* x4415[3] */ {  0.600000f,  8.000000f,  0.000000f,  0.000000f, },
	/* x4415[4] */ {  0.800000f,  8.000000f,  0.000000f,  0.000000f, },
	/* x4415[5] */ {  1.000000f,  -10.000000f,  -4.000000f,  0.200000f, },
};
...
static CAnimKeyframe x4542[] = {
	/* x4542[0] */ {  0.000000f,  0.000000f,  0.000000f,  -0.100000f, },
	/* x4542[1] */ {  0.300000f,  0.000000f,  0.000000f,  0.250000f, },
	/* x4542[2] */ {  0.400000f,  0.000000f,  0.000000f,  0.300000f, },
	/* x4542[3] */ {  0.500000f,  0.000000f,  0.000000f,  0.250000f, },
	/* x4542[4] */ {  1.000000f,  0.000000f,  0.000000f,  -0.100000f, },
};
static CAnimKeyframe *x4576 = 0;
static CAnimKeyframe *x4583 = 0;
static CAnimKeyframe *x4590 = 0;
static CAnimKeyframe x4597[] = {
	/* x4597[0] */ {  0.000000f,  0.000000f,  0.000000f,  -0.250000f, },
	/* x4597[1] */ {  0.100000f,  0.000000f,  0.000000f,  -0.050000f, },
	/* x4597[2] */ {  0.150000f,  0.000000f,  0.000000f,  0.350000f, },
	/* x4597[3] */ {  0.420000f,  0.000000f,  0.000000f,  0.400000f, },
	/* x4597[4] */ {  0.500000f,  0.000000f,  0.000000f,  0.350000f, },
	/* x4597[5] */ {  1.000000f,  0.000000f,  0.000000f,  -0.250000f, },
};
...
static CDataWeaponspec x1887[] = {
	/* x1887[0] */ {  "hammer",  &x44[41],  &x44[42],  &x44[43],  0,x4754,  96,  125,  10,  0,  3,  4.000000f,  -20.000000f,  0.000000f,  0.000000f,  5.000000f, },
	/* x1887[1] */ {  "gun",  &x44[26],  &x44[27],  &x44[28],  3,x4891,  64,  125,  10,  500,  1,  32.000000f,  4.000000f,  50.000000f,  6.000000f,  5.000000f, },
	/* x1887[2] */ {  "shotgun",  &x44[32],  &x44[33],  &x44[34],  3,x5076,  96,  500,  10,  0,  1,  24.000000f,  -2.000000f,  70.000000f,  6.000000f,  5.000000f, },
	/* x1887[3] */ {  "grenade",  &x44[38],  &x44[39],  &x44[40],  0,x5261,  96,  500,  10,  0,  1,  24.000000f,  -2.000000f,  0.000000f,  0.000000f,  5.000000f, },
	/* x1887[4] */ {  "rifle",  &x44[47],  &x44[48],  &x44[49],  0,x5398,  92,  800,  10,  0,  5,  24.000000f,  -2.000000f,  0.000000f,  0.000000f,  5.000000f, },
	/* x1887[5] */ {  "ninja",  &x44[44],  &x44[45],  &x44[46],  3,x5535,  96,  800,  10,  0,  9,  0.000000f,  0.000000f,  40.000000f,  -4.000000f,  5.000000f, },
};
